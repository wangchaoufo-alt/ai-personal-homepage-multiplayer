const fallbackNewsItems = [
  {
    title: "Agent 模式爆发：Claude Code、ChatGPT Tasks 引领自主工作流",
    category: "大模型",
    date: "2026-06-13",
    summary: "从代码编写到复杂任务拆解，AI Agent 正在从实验室走向生产环境，成为 2026 年最确定的 AI 趋势。"
  },
  {
    title: "本地大模型进入消费级时代：NPU + 量化技术突破",
    category: "本地AI",
    date: "2026-06-12",
    summary: "骁龙 Elite X 和 Apple M4 的 NPU 让 70 亿参数模型在笔记本上流畅运行，本地 AI 不再是发烧友专属。"
  },
  {
    title: "视频生成进入分钟级一致性时代：Sora 2.0 与 Veo 3 对比",
    category: "AI视频",
    date: "2026-06-11",
    summary: "AI 视频长度突破 5 分钟，角色一致性大幅提升，影视级短片可单人生成。"
  },
  {
    title: "RTX 5090 即将到来：显存带宽翻倍，本地 AI 再升级",
    category: "硬件",
    date: "2026-06-10",
    summary: "新一代 Blackwell 架构 GPU 显存带宽提升 80%，为大模型推理和视频生成提供更强动力。"
  },
  {
    title: "MCP 协议标准化：AI 工具调用进入互联时代",
    category: "工作流",
    date: "2026-06-09",
    summary: "Model Context Protocol 成为行业标准，AI 可无缝调用本地工具、API 和数据源。"
  },
  {
    title: "多模态 RAG 崛起：图像、视频、文档联合检索成新范式",
    category: "大模型",
    date: "2026-06-08",
    summary: "企业级 RAG 系统不再局限于文本，开始支持图表、流程图和产品图片的跨模态理解。"
  },
  {
    title: "ComfyUI 工作流成主流：节点式 AI 创作降低门槛",
    category: "AI视频",
    date: "2026-06-07",
    summary: "可视化节点编辑器让图生视频、LoRA 训练和批量处理变得前所未有的简单。"
  },
  {
    title: "DDR7 显存标准落地：本地 AI 硬件加速换代",
    category: "硬件",
    date: "2026-06-06",
    summary: "新一代 GDDR7 显存带宽提升 40%，消费级显卡本地跑 130B 大模型成为可能。"
  },
  {
    title: "AI 自动化工作流从单任务转向多 Agent 协作",
    category: "工作流",
    date: "2026-06-05",
    summary: "多个 AI Agent 协同完成调研、写作、审核、发布的完整内容生产链路。"
  },
  {
    title: "个人 AI 站点成为知识资产新形态：超哥的加油站实践",
    category: "工作流",
    date: "2026-06-04",
    summary: "把 AI 资讯、论坛、项目与工具链整合为个人品牌站点，打造可积累的数字资产。"
  }
];
